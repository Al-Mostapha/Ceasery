...
class godGate{
    ...
    public static function getPlayerGateEffect($idPlayer, $unit){
        ...
        $playerGate = selectFromTable("*", "god_gate", "id_player = $idPlayer")[0];
        if(!WorldUnit::isGodGateEffective($unit["t"])){
            return $effect;
        }
