        ...
        return `
                    <div id='dialg_box'>
                        ...
                        <div class="nav_bar">
                            ...
                            <div id="NavSelectList" class="flex"></div>
                            <div class="right-nav">
                                <div class="nav_icon">
        ...
        switch (rank_for) {
            ...
            case Elkaisar.Rank.RankFor.Player:
                $("#NavSelectList").html(Elkaisar.Ui.Select.make(
                        [
                            {value: "ByName", title: "عام"},
                            {value: "ByName", title: "برستيج"},
                            {value: "ByName", title: "شرف"}
                        ],
                        0, {
                            width: 158,
                            height: 200
            ...
            case Elkaisar.Rank.RankFor.Guild:
                 $("#NavSelectList").html(Elkaisar.Ui.Select.make(
                        [
                            ...
                            {value: "ByName", title: "برستيج"},
                            {value: "ByName", title: "شرف"},
                            {value: "ByName", title: "عدد الأعضاء"}
                        ],
                        0, {
                            width: 158,
                            height: 200
            ...
            case Elkaisar.Rank.RankFor.Hero:
                 $("#NavSelectList").html(Elkaisar.Ui.Select.make(
                        [
                            {value: "ByName", title: "عام"},
                            {value: "ByName", title: "مستوى"},
                            {value: "ByName", title: "قوة السيطرة"},
                            {value: "ByName", title: "الشجاعة"},
                            {value: "ByName", title: "الدفاع"}
                        ],
                        0, {
                            width: 158,
                            height: 200
    ...
    var toolTip = ` <div class="tooltip-container">
                        <div class="header">
                            <div class="mat_name pull-R">
                                ${Elkaisar.BaseData.Items[matrial_type].name}
                            </div>
                            <div class="mat_price pull-L">
                                <p class="pull-L"> ${Elkaisar.BaseData.Items[matrial_type].gold}</p>
                                <div class="pull-R">
                                    <img src="images/icons/resource/gold.png"/>
                                </div>
                            </div>
                        ...
                        <div class="desc">
                            ${Elkaisar.BaseData.Items[matrial_type].desc}
                        </div>
                        <div class="desc">
                            ${Elkaisar.BaseData.Items[matrial_type].long_desc}
                        </div>
                    </div>`;
...
$(document).on('click', '#openPlayerItemBox', function () {
    ...
    $.ajax({
        'url': `${NODE_URL}/api/AItem/openItemBox`,
        'data': {
