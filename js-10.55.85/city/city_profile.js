        ...
        return $.ajax({
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                if(json_data){
                    ...
                    Elkaisar.CurrentCity.City.pop   = json_data.pop;
                    
                    city_profile.refresh_resource_view();
                    Elkaisar.CurrentCity.City.LS = Math.ceil(Date.now()/1000);
        ...
        $.ajax({
            ...
            success: function (data, textStatus, jqXHR) {
                if(isJson(data)){
                    ...
                    var json_data = JSON.parse(data);
                    Elkaisar.CurrentCity.City.food     = json_data.city.food;
                    Elkaisar.CurrentCity.City.wood     = json_data.city.wood;
                    Elkaisar.CurrentCity.City.stone    = json_data.city.stone;
                    Elkaisar.CurrentCity.City.stone    = json_data.city.stone;
                    Elkaisar.CurrentCity.City.coin     = json_data.city.coin;
                    Elkaisar.CurrentCity.City.food_out = json_data.city.food_out;
                    city_profile.refresh_resource_view();
