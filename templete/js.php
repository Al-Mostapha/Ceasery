...
?>
        ...
        <script type="text/javascript" src="js<?=JS_VERSION?>/lib/jquery-3.2.1.min.js"></script>
        ...
        <script type="text/javascript" src="js<?=JS_VERSION?>/base/LPreLoad.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/base/LBaseData.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/base/base.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/base/boxWrapper.js"></script>
        ...
        <script type="text/javascript" src="js<?=JS_VERSION?>/city/city_profile.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/city/army_building.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/interatction.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/base/schadular.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/building.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/city/cityBuilding.js"></script>
        ...
        <script type="text/javascript" src="js<?=JS_VERSION?>/menu-list/menuList.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/menu-list/exchange.js"></script>
        ...
        <script type="text/javascript" src="js<?=JS_VERSION?>/ws/lib/battel.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/ws/lib/guild.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/ws/lib/mail.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/ws/lib/hero.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/ws/lib/player.js"></script>
        ...
        <script type="text/javascript" src="js<?=JS_VERSION?>/message.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/quest.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/lastUtil.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/tools/luck_wheel.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/tools/market.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/tools/palace.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/tools/spy.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/navigate.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/animation.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/equipment.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/tools/tradeCenter.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/tools/jop.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/battel/joinAttack.js"></script>
        <script type="text/javascript" src="js<?=JS_VERSION?>/battel/battelField.js"></script>
...
if(!defined("DEV_MODE")){
    echo '-->';
    echo '  <script type="text/javascript" src="js'.JS_VERSION.'/lib/jquery-3.2.1.min.js"></script>
            <script type="text/javascript" src="js'.JS_VERSION.'/lib/jquery.nicescroll.min.js"></script>
            <script type="text/javascript" src="js'.JS_VERSION.'/lib/jquery-ui.min.js"></script>
            <script type="text/javascript" src="js'.JS_VERSION.'/lib/phaser.min.js"></script>
